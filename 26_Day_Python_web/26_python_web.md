...
```sh
shiva@shiva:~/Desktop$ mkdir python_for_web
shiva@shiva:~/Desktop$ cd python_for_web/
shiva@shiva:~/Desktop/python_for_web$ virtualenv venv
shiva@shiva:~/Desktop/python_for_web$ source venv/bin/activate
(env) shiva@shiva:~/Desktop/python_for_web$ pip freeze
(env) shiva@shiva:~/Desktop/python_for_web$ pip install Flask
(env) shiva@shiva:~/Desktop/python_for_web$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shiva@shiva:~/Desktop/python_for_web$
```
...
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shiva@shiva:~/Desktop/python_for_web$ touch requirements.txt
(env) shiva@shiva:~/Desktop/python_for_web$ pip freeze > requirements.txt
(env) shiva@shiva:~/Desktop/python_for_web$ cat requirements.txt
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
MarkupSafe==1.1.1
Werkzeug==0.16.0
(env) shiva@shiva:~/Desktop/python_for_web$ touch Procfile
(env) shiva@shiva:~/Desktop/python_for_web$ ls
Procfile          env/              static/
