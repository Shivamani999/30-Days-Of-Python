...
# main.py file
import mymodule
print(mymodule.generate_full_name('shiva', 'konam')) # shiva konam
```
...
print(generate_full_name('shiva','konam'))
...
```sh
python script.py shiva 30DaysOfPython
```

The result:

```sh
Welcome shiva. Enjoy  30DayOfPython challenge! 
```
