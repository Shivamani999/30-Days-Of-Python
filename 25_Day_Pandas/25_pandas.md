...
```python
dct = {'name':'shiva','country':'Finland','city':'Helsinki'}
```
...
```python
data = {'Name': ['shiva', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'shiva', 'Country': 'Finland', 'City': 'Helsinki'},
...
```sh
curl -O https://raw.githubusercontent.com/shiva/30-Days-Of-Python/master/data/weight-height.csv
```
