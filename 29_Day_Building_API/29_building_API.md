...
#
MONGODB_URI='mongodb+srv://shiva:your_password@30daysofpython-twxkr.mongodb.net/test?retryWrites=true&w=majority'
...
We can access signle document using an id, let's access shiva using his id.
